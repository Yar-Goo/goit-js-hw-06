...
// HTML містить список <ul class="gallery"></ul>
...
const makeImageItemMarkup = ({ alt, url }) => {
  return `<li><img src="${url}" alt="${alt}"></li>`;
};

const makeImageItem = images.map(makeImageItemMarkup).join("");
console.log(makeImageItem);

imagesListItem.insertAdjacentHTML("afterbegin", makeImageItem);